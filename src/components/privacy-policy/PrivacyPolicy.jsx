...
const PrivacyPolicy = () => {
  return (
    <div className='policy-container'>
          ...
          <h1 >What personal information do we collect from the people that visit our website</h1>
          ...
          <ol>Any of the information we collect from you may be used in one of the following ways:
        ...
        <p>Google’s advertising requirements can be summed up by Google’s Advertising Principles. They are put in place to provide a positive experience for users. Google Advertisement Policies
        </p>
        <br />
